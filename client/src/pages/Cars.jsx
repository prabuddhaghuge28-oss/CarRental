...
const {cars,axios}= useAppContext()
   ...
   const searchCarAvailability = async ()=>{
    try{
      ...
      if(data.success){
        ...
        if(Array.isArray(data.availableCars) && data.availableCars.length === 0){
  ...
  return (
    <div>
     ...
     <Title title='Available Cars' subTitle='Browse our selection of premium vehicles availble for your next adventures'/>
     <motion.div 
