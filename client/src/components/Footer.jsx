  ...
  return (
    ...
    className='px-6 md:px-16 lg:px-32 mt-60 text-sm text-gray-500 '>
            ...
            className='flex flex-wrap justify-between gap-8 pb-6 border-borderColor border-b'>
                <div>
                    ...
                    className='max-w-80 mt-3'>
                       Premium car rental service with a selection of luxury and everyday vehicles for all your driving needs.
                    </motion.p>
                    <motion.div 
                    initial={{opacity:0}}
                    whileInView={{opacity:1}}
            ...
            className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p><h2><b>This website is made by Vishwajeet</b></h2></p>
